...
mariadb -e "USE turtlenas; CREATE TABLE files_admin (fullpath VARCHAR(255) PRIMARY KEY, parent VARCHAR(255), name VARCHAR(255),date VARCHAR(255), size VARCHAR(255), hash CHAR(244) );"
