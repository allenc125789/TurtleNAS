...
# Install:
> [!IMPORTANT]
> It is recommeneded doing this on a fresh install of latest Debian Stable, with no DE/WM installed. While this program may work on other configurations, i'll only be maintaining it from Debian 12.5.0 and up.
