...
# Install:
> [!IMPORTANT]
> Recommeneded on fresh install of latest Debian Stable, with no DE installed. While this program may work on other configurations, i'll only be maintaining it from Debian (Stable) 12.5.0 and up.
