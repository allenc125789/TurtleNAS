...
####SERVER.
#: Dependancies.
aDEPENDS=("gpg" "sudo" "rsync" "sshfs" "nginx" "libnginx-mod-http-js" "python3" "python3-pam" "ufw" "git" "php8.2" "php8.2-fpm")
    #: Dependancy Check
...
ln -v -s /etc/nginx/sites-available/netacbackup-profile /etc/nginx/sites-enabled/
    #: Web page files.
aWEBFILES=("/index.html" "/html" "/js" "/css" "/php" "/bash" "/python")
